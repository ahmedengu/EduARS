    ...
    .controller('Ctrl', ['$scope', function ($scope, $rootScope) {
        ...
        setInterval(function () {
            Office.context.document.getSelectedDataAsync(Office.CoercionType.SlideRange, function (asyncResult) {
                ...
                if (asyncResult.status != "failed" && $scope.slideNum != asyncResult.value.slides[0].index) {
        ...
        $scope.goToS = function (slide) {
            if (slide)
                Office.context.document.goToByIdAsync(slide, Office.GoToType.Index, function (asyncResult) {
                });
        }
            ...
            Office.context.document.getFilePropertiesAsync(function (asyncResult) {
                ...
                lecture.save(null, {
                    ...
                    error: function (lecture, error) {
                        showNotification("Alert", 'Failed to create new object, with error code: ' + error.message);
                    }
                });
            });
        ...
        if (Office.context.document.settings.get("lectureId") && Office.context.document.settings.get("lectureId").length) {
            retreiveLecture();
        } else {
            createLecture();
        }
            ...
            $scope.questions[index]
                .destroy({
                    ...
                    error: function (myObject, error) {
                        showNotification("Alert", 'Failed to destroy object, with error code: ' + error.message);
                    }
                });
        }
